...
# ============================================
# YOUTUBE DOWNLOADER - SIMPLIFIED WORKING
# ============================================

class YouTubeDownloader:
    @staticmethod
    def download(url, path):
        """Simple YouTube download with timeout and error handling"""
        try:
            ydl_opts = {
